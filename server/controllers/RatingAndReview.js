...
exports.createRating = async (req, res) => {
  try {
    ...
    // in above code we find particular course through courseid and then each course has its userIds stored in array so we r searching student userId by using  elemMatch and eq in array of enrolled student inside course 
